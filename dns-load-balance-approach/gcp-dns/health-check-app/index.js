/*
This is an asynchronous health check program. 
*/
...
/**
Initalizes the axios object.
**/
function initAxios(configObject){
  var config = { baseURL: configObject.baseUrl };
...
async function sendHealthCheckRequestSync() {
  ...
  var response = await axiosCustom.get(uri)
